...
export default function ToolView({ params }) {
  ...
  return (
    <div className="flex lg:flex-row  flex-col lg:items-start items-center w-full lg:h-screen gap-7 min-h-screen clash-display lg:justify-center sm:mt-12 lg:mt-16 xl:mt-0 max-[1300px]:gap-0 px-2 sm:px-0 ">
      ...
      <div className="main w-full min-h-[100vh] scrollbar-hide soverflow-y-auto flex flex-col justify-between">
        <Header showSidebar setShowSidebar={true} />
        {loading ? (
        <SingleToolPageSkeleton />
      ) : (
        <div className="flex flex-col gap-20 pt-5 w-full h-fit mb-7 sm:pl-7">
          <div className="flex justify-center xl:flex-row flex-col lg:items-start w-full  gap-24 sm:pl-4 md:pl-0 lg:pl-0 xl:pl-0  ">
            {/* <div className="lg:w-[48%] sm:w-[85%] w-[95%]"> */}
            <div className="max-w-[680px] w-full">
              <INewsLetters />
            </div>
            <div className="xl:sticky lg:top-0 xl:top-0 lg:left-0 lg:right-0 lg:bottom-0 w-full ">
              <div className="w-full xl:min-h-screen h-fit ">
                <Feature />
              </div>
