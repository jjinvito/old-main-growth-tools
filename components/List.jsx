...
export default function List({ search }) {
  ...
  return toolsDataStatus === "loading" ? (
    <div className="flex gap-5 flex-wrap items-center justify-evenly">
      <div
        role="status"
        class="max-w-sm p-4 border rounded shadow animate-pulse md:p-6 dark:border-gray-700 ml-5"
      >
      ...
      <div
        role="status"
        class="max-w-sm p-4 border rounded shadow animate-pulse md:p-6 dark:border-gray-700"
      >
        <div class="flex items-center justify-center h-48 mb-4 bg-gray-300 rounded dark:bg-gray-700">
          <svg
            class="w-10 h-10 text-gray-200 dark:text-gray-600"
