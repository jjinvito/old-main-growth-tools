...
export default function ({ data }) {
  return (
    <div className=" flex flex-col flex-wrap gap-6">
      ...
      <div className=" gradient-border gap-2 custom-shadow  justify-between dark:before:shadow-none w-[100%] h-[101px] dark:bg-black  ">
        <div className="content flex justify-between px-6 py-7   items-center   h-full dark:bg-black drop-shadow-lg  ">
