...
export default function Sidebar(props) {
  ...
  return (
    <div
      className={`max-h-[100vh] scrollbar-hide overflow-y-auto flex flex-col fixed sm:fixed top-[70px] right-0 bottom-0 xl:static gap-2 justify-start pt-5 pb-2 px-2 w-[100vw] md:w-[215px] min-w-[215px] border-r-[1px] text-left bg-white border-r-slate-100 dark:bg-black dark:border-r-dark-400
